                ...
                <tr>
                    ...
                    <td>
                        <img src="{{ Storage::url($p->foto_utama)}}"
                            style="width: 100px; height: 100px; margin: 0 .2rem;" alt="">
                    </td>
                    <td>{{$p->nama_produk}}</td>
                    <td>Rp {{$p->harga}}</td>
                    <td>
                        <a href="{{route('edit.produk', $p->id)}}" class="btn btn-sm btn-warning">Edit</a>
                        <a href="{{route('hapus.produk', $p->id)}}"
                            class="btn btn-sm btn-danger delete-confirm">Hapus</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
                ...
                <div class="container">
                    <form class="row" action="{{route('tambah.produk')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" name="nama_produk" class="form-control" id="barang" placeholder="pot" required>
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="harga" class="form-label">Harga</label>
                            <input type="text" name="harga" class="form-control" id="harga" placeholder="50.000" required>
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="bb" class="form-label">Berat barang</label>
                            <input type="text" name="berat_barang" class="form-control" id="bb"
                                placeholder="Dalam satuan gram">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="volume" class="form-label">Berat volume</label>
                            <input type="text" name="berat_volume" class="form-control" id="volume"
                                placeholder="Dalam satuan gram">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="luar" class="form-label">Diameter luar</label>
                            <input type="text" name="diameter_luar" class="form-control" id="luar"
                                placeholder="Dalam satuan centimeter">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="dalam" class="form-label">Diameter dalam</label>
                            <input type="text" name="diameter_dalam" class="form-control" id="dalam"
                                placeholder="Dalam satuan centimeter">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="tali" class="form-label">Panjang tali</label>
                            <input type="text" name="panjang_tali" class="form-control" id="tali"
                                placeholder="Dalam satuan centimeter">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="tali" class="form-label">Kategori</label>
                            <select class="form-select" aria-label="Default select example" name="kategori" id="tali" required>
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="input-group control-group">
                                <input type="file" name="foto_utama" class="form-control" id="foto_utama" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="foto" class="form-label">Foto produk</label>
                            <div class="input-group control-group increment poto">
                        ...
                        {{-- <div class="col-md-6 mb-2"> --}}
                            <div class="clone clone-foto visually-hidden">
                                ...
                                <div class="input-group">
                                    @foreach ($keyword as $k)
                                        <div class="form-check form-check-inline d-flex">
                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="keyword[]" value="{{$k->keyword}}" multiple>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea rows="15" id="konten"
                                        ...
                                        name="diskripsi" placeholder="" required></textarea>
                                </div>
                            </div>
                        </div>
